...
static int secp256k1_ecdsa_sig_sign(const secp256k1_ecmult_big_context_t *ctx, secp256k1_ecdsa_sig_t *sig, const secp256k1_scalar_t *seckey, const secp256k1_scalar_t *message, const secp256k1_scalar_t *nonce, int *recid) {
    unsigned char b[32];
    secp256k1_gej_t rp;
    secp256k1_ge_t r;
    ...
    secp256k1_ecmult_big(ctx, &rp, nonce);
