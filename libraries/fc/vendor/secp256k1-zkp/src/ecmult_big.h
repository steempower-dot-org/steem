...
typedef struct {
    ...
    secp256k1_ge_storage_t **precomp;
    ...
    /* This memory will be freed after creating the precomputation table.           */
    secp256k1_fe_t *z_ratio;
} secp256k1_ecmult_big_context_t;
 ...
 */
secp256k1_ecmult_big_context_t* secp256k1_ecmult_big_create(
    const unsigned int bits
 ...
 */
void secp256k1_ecmult_big_destroy(
    secp256k1_ecmult_big_context_t* bmul
...
static void secp256k1_ecmult_big(
    const secp256k1_ecmult_big_context_t* bmul,
    secp256k1_gej_t *r,
